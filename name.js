...
// // use a promise to output name layers into DOM first
// const outputLayers = new Promise(function(resolve, reject) {
//       document.getElementById('name').innerHTML = createLetterContainers(createLetterLayers(createLetterArray(name))).join('');
//       resolve();
// });
